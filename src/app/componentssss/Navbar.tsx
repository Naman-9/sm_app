...
const Navbar = () => {
  return (
    <nav className="bg-black">
      <div className="mx-auto max-w-[1200px] px-[20px] py-2 flex justify-between items-center">
        <div className=''>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="100"
            height="100"
            viewBox=".182 .548 511.304 171.879"
            id="instagram"
            fill='#0095f6'
          >
        ...
        <div className="flex">
          <Button
            variant="default"
            className=" bg-[#0095f6] hover:bg-[#1877f2] text-base text-gray-200 px-5"
            size="sm"
          >
          ...
          <Button
            variant="link"
            className="hover:no-underline text-base text-[#0095f6] hover:text-gray-200 px-5"
            size="sm"
          >
